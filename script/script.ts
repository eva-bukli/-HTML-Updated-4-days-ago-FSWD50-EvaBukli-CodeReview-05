class Locations {
	classy ; name ; city ; zipcode ; address ; img ; postdate; postyear;
	constructor(classy:string,name:string,city: string, zipcode:number,address:string, img:string, postdate:string, postyear:number) {
		this.classy=classy;
		this.name=name;
		this.city=city;
...
class Restaurant extends Locations {
	tel; type; webaddress;
	constructor(classy:string,name:string,city: string, zipcode:number,address:string, img:string,postdate:string,postyear:number,tel:string, type:string, webaddress:string) {
...
class Events extends Locations {
	date; time; price; webaddress;
	constructor(classy:string,name:string,city: string, zipcode:number,address:string, img:string, postdate:string,postyear:number,date:string, time:string, price:string, webaddress:string) {
		super(classy, name , city , zipcode , address , img,postdate,postyear)
		this.date=date;
		this.time=time;
		this.price=price;
...
$('#alla').click(function() {
	...
	everythings.sort(function(a, b){
	    ...
	    var dateA:any=a.postyear, dateB:any=b.postyear
